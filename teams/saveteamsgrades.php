...
//	
	...
	//Actualizaci�n del agrupamiento recogiendo el contador de repeticiones de los miembros
	$contador=blended_actualizar_agrupamiento($teams,$item,$blended,$delete_empty);
	...
	/* Borro las calificaciones guardadas para esa tarea ya que se pueden haber quitado miembros
	 *  y por tanto no deben estar en la tabla
	 */
