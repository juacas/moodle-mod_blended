...
// Get the strings --------------------------------------------------------------- 
    ...
    $strstatusdetails 		= get_string('statusdetails','blended');
...
// Print the page header ---------------------------------------------------------
    ...
    $navigation = build_navigation(array(array('name' => $blended->name,'link'=>"../../mod/blended/view.php?a=$blended->id", 'type'=>'misc'),
                                        array('name' => $strscanpage,'link'=>"../../mod/blended/scan.php?a=$blended->id", 'type'=>'misc'),
                                         array('name' => $strjobstatuspage,'link'=>"../../mod/blended/jobstatus.php?a=$blended->id&jobid=$jobid&page=$page", 'type'=>'misc'),
 									array('name' => $strstatusdetails,'link'=>null, 'type'=>'misc')));
