...
$string['cantprintlabel']        = ' Hasta que el estudiante no introduzca su DNI no se puede imprimir su etiqueta';
...
$string['group']			   = 'Eliga el agrupamiento: ';
$string['grouping']			   = '  ';
...
$string['omrPath']                = 'Path de la herramienta nativa OMR';
