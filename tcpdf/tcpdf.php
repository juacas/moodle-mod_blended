	...
	class TCPDF {
		...
		*/
		public function Error($msg) {
			...
			// Throw exception to give a change of resuming
...
//echo ("<p>$file<p>w=$pixw h=$pixh w=$w h=$h");
			// calculate image width and height on document
			if (($w <= 0) AND ($h <= 0)) {
//echo ("<p>scale=$this->imgscale");
		...
		public function Output($name='doc.pdf', $dest='I') {
			...
			switch($dest) {
				case 'I': {
					...
					if (ob_get_contents()) {
						//JAV. TODO check why is failing the call to Error(). Function declared in line 1845
...
//===============
		...
		* @since 1.1
		*/
		 public function write2DBarCode($code, $x='', $y='', $w=0, $h=0, $type='',  $align='', $resize=false, $dpi=300,  $link='') 
		 {
		 	require_once(K_PATH_MAIN.'../QR/qr_lib.php');
